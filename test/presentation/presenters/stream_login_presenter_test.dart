...
void main() {
  ...
  test('Should emit password erro if validation fails', () {    
    mockValidation(value: 'error');
  ...
  test('Should emit email and password succeeds if validation sucess', () async { 
  ...
  test('Should emit corret events on Authentication success', () async { 
  ...
  test('Should emit corret events on InvalidCredentialsError', () async { 
  ...
  test('Should emit corret events on UnexpectedError', () async { 
